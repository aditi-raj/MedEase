...
export const PasskeyModal = () => {
  ...
  //   console.log('Admin passkey:', process.env.NEXT_PUBLIC_ADMIN_PASSKEY);

  //   if (!path) return;
    
  //   // Let's use a hardcoded value for testing
  ...
  //     localStorage.setItem("accessKey", encryptedKey);
  //     setOpen(false);
  //     router.push("/admin");  // Add this line to redirect after validation
  //   } else {
  //     console.log('Passkey invalid');
  //     setError("Invalid passkey. Please try again.");
  //   }
  // };
